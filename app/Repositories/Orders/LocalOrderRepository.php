...
class LocalOrderRepository extends BaseOrderRepository implements OrderTypeInterface
{
    ...
    public function validateData(){
        ...
        $validator=Validator::make($this->request->all(), array_merge($this->expeditionRules(),$this->paymentRules()), $this->expeditionMessages());
    ...
    public function redirectOrInform($errors = []){
        if($this->status){
            ...
            return redirect()->route('cart.checkout')->withInput()->withErrors($errors);
        }
    }
